...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/respic/res1_1.png" alt="Slide 1" />
        </div>
        <div class="item">
...
[Media coverage:](https://economictimes.indiatimes.com/news/science/new-computer-model-can-predict-indias-pollution-levels-months-earlier/articleshow/70446469.cms) <i>New model can predict India's pollution levels months earlier</i>
